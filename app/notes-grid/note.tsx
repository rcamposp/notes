    ...
    return (
        ...
        <div className="block max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <div className='grid grid-cols-2'>
                <div>
                    <span className={`capitalize bg-${bgColor}-500  text-white rounded-full text-center px-2 py-1'`}>{note.category}</span>
                    <br className='bg-orange-500 bg-blue-500 bg-green-500'></br>
                </div>
            ...
            <h5 className="mb-2 mt-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{note.title}</h5>
